...
def train(args, model, optimizer, dataloader_source, dataloader_target, dataloader_val, model_D, optimizer_D, IMG_MEAN, cropSize):
    ...
    print('Type of DIscriminator (0 = FCD 1 = DSC): ',args.Discriminator)
    print('use pseudo labels: ',args.use_pseudolabels)
    print('use pretreined model: ', args.use_pretrained_model)
